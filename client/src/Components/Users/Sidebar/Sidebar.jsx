...
function Sidebar(props) {
  ...
  const non_activeElements = 'block gap-2 flex py-3  hover:bg-blue-400 hover:text-white  -mx-1 px-1 rounded-md transition-all hover:scale-110 hover:shadow-gray-300 mt-2 ';
  const activeElements = 'block flex gap-2 py-3  bg-blue-600 text-white rounded-md shadow-md -mx-4 px-4';
